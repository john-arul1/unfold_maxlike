...
# if guess is given use it, else chack for theoretical value, else default is phi0 
    ...
    bn1=R.dot(x1s*scale/flnorm)
    bnreg=R.dot(x2s*scale/flnorm)
    error=(bn1-Bn)/Bn*100.0
    err_reg=(bnreg-Bn)/Bn*100.0
